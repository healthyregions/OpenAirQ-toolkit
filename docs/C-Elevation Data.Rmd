...
download.file("https://drive.google.com/drive/folders/1sSgHVOsiLXEJYCUAR5u-IxZss3gXGD9O", "../data/LAC_Elevation.tif")
#unzip(zipfile = "../data/LAC_Elevation.tif.zip", exdir = "./temp")
lac.elevation <- raster("../data/LAC_Elevation.tif")
```
